...
class Backend:
    ...
    def x25519_supported(self) -> bool:
        ...
        if self._fips_enabled and not self._lib.CRYPTOGRAPHY_OPENSSL_320_OR_GREATER:
            return False
        return True
    ...
    def poly1305_supported(self) -> bool:
        if self._fips_enabled:
            return False
        elif self._lib.CRYPTOGRAPHY_IS_BORINGSSL or self._lib.CRYPTOGRAPHY_IS_LIBRESSL:
            return True
        else:
